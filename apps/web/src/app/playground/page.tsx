...
export default function PlaygroundPage() {
  ...
  const is402 = result ? result.includes('"PAYMENT_REQUIRED"') : false;
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div className="glass rounded-xl p-4 h-[340px] overflow-auto">
              {result ? (
                <pre className={`text-xs font-mono whitespace-pre-wrap ${is402 ? 'text-yellow-400' : 'text-neon-green'}`}>{result}</pre>
              ) : (
        ...
        {is402 && (
          <div className="mt-6 glass rounded-xl p-4 border border-yellow-500/30 text-sm">
            <p className="text-yellow-400 font-semibold mb-1">Payment Required (402)</p>
            <p className="text-muted-foreground text-xs">
              This tool requires payment via x402 or MPP. See the <a href="/docs" className="text-neon-green underline">docs</a> for integration details.
            </p>
          </div>
        )}
